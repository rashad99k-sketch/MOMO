...
def get_settings():
    return {
        ...
        "ai_market_mode": str(os.getenv("AI_MARKET_MODE", "SHADOW")).upper(),
        "ai_min_entry_score": float(os.getenv("AI_MIN_ENTRY_SCORE", "78")),
        "ai_min_confidence": float(os.getenv("AI_MIN_CONFIDENCE", "70")),
        "ai_memory_path": os.getenv("AI_MEMORY_PATH", "logs/ai_market_memory.jsonl"),
    }
